...
# Numeric Limits  
Below demonstrates the limits of all the numeric primitive in c++ and therefore can help in chosing which would work best for certain scernarios.  

```{r, engine="C++", engine.path="/Users/nick/hathaway/cppInline/cppInline_detail",engine.opts="CXX=clang++", highlight=TRUE, comment=""}
