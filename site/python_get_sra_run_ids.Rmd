...
The following script contains code to query SRA for SRA numbers from expeirment(SRX/ERX), sample(SRS/ERS), and project(SRP/XRP) identifiers, here's a link to download script here [getSraRunsFromAccIds.py](scripts/python/getSraRunsFromAccIds.py)
...
./getSraRunsFromAccIds.py --identifiers SRP046206,SRX188939,SRS807544,SRR1759594
```

```{r test_download, engine='bash', eval = T, echo = FALSE}
scripts/python/getSraRunsFromAccIds.py --identifiers SRP046206,SRX188939,SRS807544,SRR1759594
```
